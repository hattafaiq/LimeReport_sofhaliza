...
//struct t_chart_parade_vib_recip vib_rcs;
...
{
    qDebug()<<"<LR masuk 4>-------------------------------------->"<<stimming_EC<<stimming_EO<<stimming_IC<<stimming_IO<<stimming_Silinder;
//  ReportEnginePrivate a;

    Q_D(ReportEngine);
    d->timming_EC = stimming_EC;
    d->timming_EO = stimming_EO;
...
//    }
    ...
    //coba mode sinyal slot disini emit atau signal
   // emit d->data_table(stimming_EC,stimming_EO,stimming_IC,stimming_IO,stimming_Silinder);
}
