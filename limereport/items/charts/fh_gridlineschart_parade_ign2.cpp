#include "fh_gridlineschart_parade_ign2.h"


namespace LimeReport {
void fh_gridlineschart_parade_ign2::paintChart(QPainter *painter, QRectF chartRect, QVector<float> timming, QVector<float> PeakAbs, int odd_evn
                                               ...
                                               QVector<float> peak_ign, QVector<float> derajat_ign, QString satuan_ign)
{
    ...
    paintGrid_paradeIGN2(painter, gridRect,timming[0],timming[2],timming[1],timming[3],timming[4],PeakAbs,odd_evn
...
void fh_gridlineschart_parade_ign2::paintSerialLines(QPainter* painter, QRectF barsRect)
{
