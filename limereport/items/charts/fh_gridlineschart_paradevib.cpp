...
void fh_gridlineschart_vibrecip::paintChart(QPainter *painter, QRectF chartRect, QVector<float> timming)
{
    ...
    paintGrid_paradeVib(painter, gridRect,timming[0],timming[2],timming[1],timming[3],timming[4]);
    paintSerialLines(
        painter,
